...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/Homeinactive.svg
  SvgGenImage get homeinactive =>
      const SvgGenImage('assets/img/icons/Homeinactive.svg');
  ...
  /// File path: assets/img/icons/articleinactive.svg
  SvgGenImage get articleinactive =>
      const SvgGenImage('assets/img/icons/articleinactive.svg');
  ...
  /// File path: assets/img/icons/menuinactive.svg
  SvgGenImage get menuinactive =>
      const SvgGenImage('assets/img/icons/menuinactive.svg');
  ...
  /// File path: assets/img/icons/searchinactive.svg
  SvgGenImage get searchinactive =>
      const SvgGenImage('assets/img/icons/searchinactive.svg');
...
class $AssetsImgStoriesGen {
  ...
  /// File path: assets/img/stories/story_11.jpg
  AssetGenImage get story11 =>
      const AssetGenImage('assets/img/stories/story_11.jpg');
